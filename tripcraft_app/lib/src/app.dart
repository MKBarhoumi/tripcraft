      ...
      routes: [
        ...
        GoRoute(
          ...
          builder: (context, state) {
            ...
            return ItineraryGenerationScreen(
              destination: extra?['destination'] ?? 'Unknown',
              startDate: extra?['startDate'] ?? DateTime.now(),
              endDate: extra?['endDate'] ?? DateTime.now().add(const Duration(days: 7)),
              travelStyle: extra?['travelStyle'],
              budgetTier: extra?['budgetTier'],
